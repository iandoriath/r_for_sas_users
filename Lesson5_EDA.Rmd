...
Using the `clinical_trial` dataset, calculate:
...
1. Create a histogram of a numeric variable (e.g., BMI) using ggplot2. Customize the bins if necessary and add a title.
...
Using the `longitudinal_data` dataset, create a line plot showing the mean Measurement over time for each Treatment group. Add error bars representing the standard error of the mean.
